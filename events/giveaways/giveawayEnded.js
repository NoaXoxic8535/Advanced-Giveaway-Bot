    ...
    winners.forEach((member) => {
      member.send({
        ...
        embeds: [new EmbedBuilder()
          ...
          .setColor("#2F3136")
          .setDescription(`Hello there, ${member.user}!\nCongratulations on your victory in the giveaway! You've won the amazing prize of ${giveaway.prize}. To claim your well-deserved reward, please reach out to ${giveaway.hostedBy} via direct message. Enjoy your prize, and once again, congratulations!`)
          .setTimestamp()
          .setFooter({
